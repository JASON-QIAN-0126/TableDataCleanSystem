      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="download-button-container">
            ...
            <div className={`download-button1 ${light ? "light" : ""}`} onClick={handleDownload} data-tooltip="Size: 20Mb">
            <div className="download-button1-wrapper">
              <div className="download-button1-text">Download</div>
                <span className="download-button1-icon">
